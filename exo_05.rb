# {} concatene des entiers dans un string
#affiche la phrase :
#"On va compter le nombre d'heures de travail à THP" et retourne à la ligne
puts "On va compter le nombre d'heures de travail à THP"
# {} affiche "Travail : 550"
puts "Travail : #{10 * 5 * 11}"
# affiche "En mintes ça fait : 33000"
puts "En minutes ça fait : #{10 * 5 * 11 * 60}"
#affiche "Et en secondes ?"
puts "Et en secondes ?"
#affiche le resultat de l'opération => "1 980 000"
puts 10 * 5 * 11 * 60 * 60
#affiche "Est-ce que c'est vrai que 3 + 2 < 5 - 7 ?"
puts "Est-ce que c'est vrai que 3 + 2 < 5 - 7 ?"
#  test si 5 < -2 et affiche "FALSE"
puts 3 + 2 < 5 - 7
